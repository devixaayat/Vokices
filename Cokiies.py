# Scripted by : Devi  
# GitHub      : github.com/devixaayat
# Contact     : facebook.com/devikinge
# YouTube     : youtube.com/devidon
	...
	try:
		...
		with req.get(url) as response_body:
			...
			if 'checkpoint' in cookie:sys.exit("\033[1;31mAccount terminated by Facebook!\033[0m")
				...
				#os.system('xdg-open https://facebook.com/devikinge')
				os.system('xdg-open https://github.com/devixaayat')
			else:
